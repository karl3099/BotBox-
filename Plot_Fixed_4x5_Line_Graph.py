...
file = "/home/greenbean/GreenBean/PlotFiles/BotBox_Dischargefile.csv"

def Plot_Fixed_4x5_Line_Graph( file ):
...
# This will be used to scale the 'X' axis of the graph.
  ...
  mAh1, mAh2, mAh3, mAh4, mAh5, mAh6, mAh7, mAh8, mAh9, mAh10, mAh11, mAh12, \
        mAh13, mAh14, mAh15, mAh16, mAh17, mAh18, mAh19, mAh20 = Ah_D.split ( ',' )
...
#----------------------------------------------------------------------------------
  ...
  Ah_D11, Ah_D12, Ah_D13, Ah_D14, Ah_D15, Ah_D16, Ah_D17, Ah_D18, Ah_D19, \
  Ah_D20 = Ah_D.split( ',' )
...
# Here, we are just looking for the last value of 'X'.
  ...
  for Line in Volts:
    if len( Line ) > 0:
      Xt, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19, y20 = Line.split( ',' )

#----------------------------------------------------------------------------------

  for Line in Volts:
    if len( Line ) > 0:
      x, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19, y20 = Line.split( ',' )

      X_Axis_4.append( float(x) ) 
      ...
      Module[15].append( float(y16) )
      Module[16].append( float(y17) )
      Module[17].append( float(y18) )
      Module[18].append( float(y19) )
      Module[19].append( float(y20) )

  axis1.clear()

  axis1.set_title( file )
  axis1.set_xlim( 0, int(Xt))
#  axis1.set_xlabel( "TIME IN MINUTES" )
  axis1.set_ylim( 6.001, 8.50 )
  ...
  axis2.clear()
  axis2.set_xlim( 0, int(Xt) )
#  axis2.set_xlabel( "TIME IN MINUTES" )
  axis2.set_ylim( 6.001, 8.50 )
  ...
  axis3.clear()
  axis3.set_xlim( 0, int(Xt) )
#  axis3.set_xlabel( "TIME IN MINUTES" )
  axis3.set_ylim( 6.001, 8.50 )
  ...
  axis4.clear()
  axis4.set_xlim( 0, int(Xt) )
  axis4.set_xlabel( "TIME IN MINUTES" )
  axis4.set_ylim( 6.001, 8.50 )
  axis4.set_ylabel( "Ch16-Ch20\n VOLTS" )
  axis4.grid(True, linewidth=1.0, color='#aaaaaa', linestyle='-')

  m16, = axis4.plot( X_Axis_4, Module[15], lw=1.0, color = 'red' )
  m17, = axis4.plot( X_Axis_4, Module[16], lw=1.0, color = 'green' )
  m18, = axis4.plot( X_Axis_4, Module[17], lw=1.0, color = 'orange' )
  m19, = axis4.plot( X_Axis_4, Module[18], lw=1.0, color = 'blue' )
  m20, = axis4.plot( X_Axis_4, Module[19], lw=1.0, color = 'gray' )


  Plot.legend( ( m1, m2, m3, m4, m5 ),
               ( 'Ch 1: ' + str(int(Ah_D1)*5) + ' mAh',
                 'Ch 2: ' + str(int(Ah_D2)*5) + ' mAh',
                 'Ch 3: ' + str(int(Ah_D3)*5) + ' mAh',
                 'Ch 4: ' + str(int(Ah_D4)*5) + ' mAh',
                 'Ch 5: ' + str(int(Ah_D5)*5) + ' mAh' ), loc=(0.83,0.72) )

  Plot.legend( ( m6, m7, m8, m9, m10 ),
               ( 'Ch 6: ' + str(int(Ah_D6)*5) + ' mAh',
                 'Ch 7: ' + str(int(Ah_D7)*5) + ' mAh',
                 'Ch 8: ' + str(int(Ah_D8)*5) + ' mAh',
                 'Ch 9: ' + str(int(Ah_D9)*5) + ' mAh',
                 'Ch 10: ' + str(int(Ah_D10)*5) + ' mAh' ), loc=(0.83,0.52) )

  Plot.legend( ( m11, m12, m13, m14, m15 ),
               ( 'Ch 11: ' + str(int(Ah_D11)*5) + ' mAh',
                 'Ch 12: ' + str(int(Ah_D12)*5) + ' mAh',
                 'Ch 13: ' + str(int(Ah_D13)*5) + ' mAh',
                 'Ch 14: ' + str(int(Ah_D14)*5) + ' mAh',
                 'Ch 15: ' + str(int(Ah_D15)*5) + ' mAh' ), loc=(0.83,0.32) )

  Plot.legend( ( m16, m17, m18, m19, m20, ),
               ( 'Ch 16: ' + str(int(Ah_D16)*5) + ' mAh',
                 'Ch 17: ' + str(int(Ah_D17)*5) + ' mAh',
                 'Ch 18: ' + str(int(Ah_D18)*5) + ' mAh',
                 'Ch 19: ' + str(int(Ah_D19)*5) + ' mAh',
                 'Ch 20: ' + str(int(Ah_D20)*5) + ' mAh' ), loc=(0.83,0.094) )

  Plot.show()

if __name__ == '__main__':
  Plot_Fixed_4x5_Line_Graph( file )
