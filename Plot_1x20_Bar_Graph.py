...
file = "/home/greenbean/GreenBean/PlotFiles/BotBox_Chargefile.csv"


def Plot_1x20_Bar_Graph( file ):
  ...
  Ah_C13, Ah_C14, Ah_C15, Ah_C16, \
  Ah_C17, Ah_C18, Ah_C19, Ah_C20 = Ah_C.split( ',' )
  ...
  AmpereHours = np.array( [int(Ah_C1), int(Ah_C2), int(Ah_C3), int(Ah_C4), \
                           ...
                           int(Ah_C13), int(Ah_C14), int(Ah_C15), int(Ah_C16), \
                           int(Ah_C17), int(Ah_C18), int(Ah_C19), int(Ah_C20)] )
